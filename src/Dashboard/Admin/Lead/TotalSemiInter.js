...
const TotalSemiInter = () => {
  ...
  const [totalsemiinter, setTotalsemiinter] = useState([]);
  ...
  const uniqueCourse = [
    ...new Set(totalsemiinter?.map((user) => user?.course?.name)),
  ];
  ...
  function handleCourseChange(event) {
    ...
    const fData = totalsemiinter?.filter(
  ...
  const handleInputChange = (event) => {
    ...
    // console.log(value);
    const fiData = totalsemiinter.filter(
        ...
        <ol className="flex h-8 space-x-2">
          ...
          <li className="flex items-center space-x-2">
            ...
            <a
              ...
              className="flex items-center px-1 capitalize hover:underline"
            >
              Total Seminar Interesteds Students
            </a>
          </li>
        </ol>
      </nav>
                    ...
                    ?.map((semiinter, i) => (
                      <tr key={semiinter._id}>
                        ...
                        <td className="p-1 border-2">
                          {semiinter.date.slice(0, 10)}
                        </td>
                        <td className="p-1 border-2">
                          {semiinter.course.name}
                        </td>
                        ...
                        <td className="p-1 border-2">
                          <p
                            ...
                            onClick={() => handleDelete(semiinter._id)}
                          >
                            Delete
                          </p>
                        </td>
