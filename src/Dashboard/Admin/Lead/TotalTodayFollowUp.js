...
const TotalTodayFollowUp = () => {
  ...
  const uniqueCourse = [
    ...new Set(etotalTodayFUp?.map((user) => user?.course?.name)),
  ];
  ...
  function handleCourseChange(event) {
    ...
    const fData = etotalTodayFUp?.filter(
  ...
  const handleInputChange = (event) => {
    ...
    // console.log(value);
    const fiData = etotalTodayFUp.filter(
        ...
        <ol className="flex h-8 space-x-2">
          ...
          <li className="flex items-center space-x-2">
            ...
            <a
              ...
              className="flex items-center px-1 capitalize hover:underline"
            >
              Total Follow up Students
            </a>
          </li>
        </ol>
      </nav>
      {/* <h3 className="text-3xl">Total Follow up Students : {etotalTodayFUp.length}</h3> */}
                    ...
                    ?.map((ttodayf, i) => (
                      <tr key={ttodayf._id}>
                        ...
                        <td className="p-1 border-2">
                          {ttodayf.date.slice(0, 10)}
                        </td>
                        <td className="p-1 border-2">{ttodayf.course.name}</td>
                        <td className="p-1 border-2">{ttodayf.batch.name}</td>
                        <td className="p-1 border-2">{ttodayf.user.name}</td>
                        <td className="p-1 border-2">{ttodayf.head.name}</td>
                        <td className="p-1 border-2">{ttodayf.name}</td>
                        <td className="p-1 border-2">{ttodayf.phone}</td>
                        <td className="p-1 border-2">{ttodayf.email}</td>
                        <td className="p-1 border-2">
                          <p
                            className="btn btn-xs btn-denger"
                            onClick={() => handleDelete(ttodayf._id)}
                          >
                            Delete
                          </p>
                        </td>
...
export default TotalTodayFollowUp;
